...
const OrderScreen = () => {
  ...
  const navigation =
    useNavigation<NavigationProp<RestaurantOrdersStackParamList>>();
  ...
  const orders: Order[] = [
      ...
      items: [
        {
          ...
          name: 'Classic Burger',
          price: 12.99,
          modifications: ['No onion', 'Extra cheese'],
        },
    ...
    },
    {
      ...
      items: [
        ...
        { id: '105', quantity: 1, name: 'Lemonade', price: 3.5 },
      ],
      total: 32.48,
      subtotal: 29.48,
      tax: 2.06,
      ...
      items: [
        {
          ...
          name: 'Chicken Wings',
          price: 14.99,
          modifications: ['BBQ sauce', 'Extra crispy'],
        },
        { id: '107', quantity: 1, name: 'Onion Rings', price: 6.99 },
        { id: '108', quantity: 3, name: 'Craft Beer', price: 7.5 },
      ],
      total: 58.47,
      subtotal: 53.47,
      tax: 3.74,
          ...
          <View className="bg-white p-5 rounded-xl mb-4">
            ...
            {orderData.specialInstructions && (
              <View className="mt-4 bg-amber-50 p-3 rounded-lg border border-amber-100">
                ...
                <Text className="text-amber-800 mt-1">
                  {orderData.specialInstructions}
                </Text>
              </View>
            )}
          ...
          <View className="bg-white p-5 rounded-xl mb-4">
            ...
            {orderData.items.map((item: OrderItem, index: number) => (
              <View
                key={item.id}
                className={
                  index !== 0 ? 'border-t border-gray-100 pt-3 pb-2' : 'pb-2'
                }
              >
