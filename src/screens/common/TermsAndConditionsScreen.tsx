      ...
      >
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          <Body color={colors.onSurfaceVariant} style={{ lineHeight: 24 }}>
            By accessing and using the Food Rush application, you accept and
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          <Body color={colors.onSurfaceVariant} style={{ lineHeight: 24 }}>
            Food Rush is a food delivery platform that connects customers with
            local restaurants. We facilitate the ordering and delivery of food
            items but do not prepare or handle the food directly.
          </Body>
        </View>
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          <Body color={colors.onSurfaceVariant} style={{ lineHeight: 24 }}>
            ...
            {'\n'}• Prices are set by individual restaurants and may change
            without notice{'\n'}• Payment is required at the time of order
            placement{'\n'}• Delivery fees and service charges apply as
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          <Body color={colors.onSurfaceVariant} style={{ lineHeight: 24 }}>
            • Delivery times are estimates and may vary due to weather, traffic,
            or other factors{'\n'}• Orders can be cancelled within 5 minutes of
            placement if not yet confirmed by the restaurant{'\n'}• Cancellation
            after restaurant confirmation may incur charges{'\n'}• We are not
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          <Body color={colors.onSurfaceVariant} style={{ lineHeight: 24 }}>
            • Restaurants are responsible for food preparation, quality, and
            safety{'\n'}• We do not guarantee the quality, safety, or
            suitability of food items{'\n'}• Please report any food safety
            concerns immediately{'\n'}• Special dietary requirements should be
            communicated directly to restaurants
          </Body>
        </View>
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          <Body color={colors.onSurfaceVariant} style={{ lineHeight: 24 }}>
            ...
            Privacy Policy{'\n'}• Your data is protected using industry-standard
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          <Body color={colors.onSurfaceVariant} style={{ lineHeight: 24 }}>
            Food Rush shall not be liable for any indirect, incidental, special,
