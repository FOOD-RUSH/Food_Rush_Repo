...
const getFAQData = (t: any): FAQItem[] => [
  {
    ...
    description: t('foodrush_description', 'Food Rush is a comprehensive food delivery platform that connects you with local restaurants in Cameroon. You can browse menus, place orders, track deliveries in real-time, and enjoy your favorite meals delivered right to your door. Our platform supports multiple payment methods including mobile money (MTN, Orange) and cash on delivery.'),
  },
  {
    id: 2,
    title: t('how_can_i_make_a_payment', 'How can I make a payment?'),
    description: t('payment_methods_description', 'Food Rush supports multiple payment methods for your convenience: Mobile Money (MTN Mobile Money, Orange Money), Cash on Delivery, and Credit/Debit Cards. Simply select your preferred payment method during checkout. For mobile money payments, you\'ll receive an SMS prompt to complete the transaction.'),
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: t('delete_account_description', 'To delete your account, go to Profile > Settings > Account Settings > Delete Account. Please note that this action is permanent and cannot be undone. All your order history, saved addresses, and preferences will be permanently removed. You can also contact our support team for assistance with account deletion.'),
  },
  {
    id: 5,
    title: t('how_does_delivery_work', 'How does delivery work?'),
    description: t('delivery_description', 'Once you place an order, the restaurant prepares your food and our delivery partner picks it up. You can track your order in real-time through the app. Delivery times typically range from 20-45 minutes depending on distance and restaurant preparation time. You\'ll receive notifications at each step of the delivery process.'),
  },
  {
    id: 6,
    title: t('what_if_my_order_is_wrong', 'What if my order is wrong or missing items?'),
    description: t('wrong_order_description', 'If your order is incorrect or missing items, please contact our support team immediately through the app or call our hotline. We\'ll work with the restaurant to resolve the issue quickly. You may be eligible for a refund, replacement, or credit for future orders depending on the situation.'),
  },
  {
    id: 7,
    title: t('how_to_track_my_order', 'How can I track my order?'),
    description: t('order_tracking_description', 'You can track your order in real-time by going to "My Orders" > "Active Orders" and selecting your current order. The tracking screen shows the order status (confirmed, preparing, ready for pickup, out for delivery, delivered) with estimated delivery time and live updates.'),
  },
  {
    id: 8,
    title: t('delivery_fees_and_charges', 'What are the delivery fees and charges?'),
    description: t('delivery_fees_description', 'Delivery fees vary by restaurant and distance, typically ranging from 300-1000 XAF. Some restaurants offer free delivery for orders above a certain amount. All fees are clearly displayed before you complete your order. There are no hidden charges - what you see is what you pay.'),
  },
];
    ...
    <CommonView>
      ...
      <View className="px-4 py-6 border-b" style={{ borderBottomColor: colors.outline + '30' }}>
        ...
        <Body color={colors.onSurfaceVariant}>
          {t('faq_subtitle', 'Find answers to common questions about Food Rush')}
        </Body>
      </View>
        ...
        >
          <View className="p-5">
            ...
            <Body color={colors.onPrimaryContainer || colors.primary} style={{ lineHeight: 20 }}>
              {t('contact_support_description', 'If you couldn\'t find the answer to your question, our support team is here to help you 24/7.')}
            </Body>
          </View>
        </Card>
      </ScrollView>
