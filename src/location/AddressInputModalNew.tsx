// src/location/AddressInputModal.tsx - Simple MVP modal with editing support
...
const AddressInputModal: React.FC<AddressInputModalProps> = ({
  ...
  const modalTitle = isEditing ? 'Modifier l\'adresse' : 'Entrer votre adresse';
          ...
          <View style={styles.buttonContainer}>
            ...
            >
              <Text style={[styles.primaryButtonText, { color: colors.onPrimary }]}>
                {isLoading ? 'Enregistrement...' : (isEditing ? 'Modifier' : 'Enregistrer')}
              </Text>
            </TouchableOpacity>
          </View>
        </View>
